...
/**
 * A user's effective role: the combination of their department and
 * seniority (spec Requirement 3 - "effective role is the combination").
 * Not a JPA entity itself; this is what gets checked against Permission rows.
 */
public final class UserRole {
    ...
    public Seniority seniority() { return seniority; }
