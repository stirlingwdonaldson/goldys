...
public class PermissionServiceImpl implements PermissionService {
    ...
    private List<Permission> matchingPermissions(UserRole role, String resource) {
        ...
        List<Permission> exact = permissionRepository
                .findByDepartmentAndSeniorityAndResource(role.department(), role.seniority(), resource);
        List<Permission> allDept = permissionRepository
                .findByDepartmentAndSeniorityAndResource(Department.ALL, role.seniority(), resource);
