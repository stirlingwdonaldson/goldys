...
/**
 * Phase 2 stub. Registers the fixed AiTool set and enforces the role model
 * (spec Requirement 9) before dispatching to a tool - resource string
 * convention: "tool.<tool-name>" (see auth.Permission's resource javadoc).
 * No tools are registered yet in the scaffold.
 */
@Component
